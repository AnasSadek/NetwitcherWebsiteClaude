...
export const PORTFOLIO_CATEGORIES_AR = [
  ...
  { id: "social-video", label: "وسائل التواصل والفيديو", color: "pink" },
...
export const portfolioProjectsAr: PortfolioProject[] = [
  ...
  },
  {
    slug: "frida-eu",
    client: "FridaEU",
    title: "تجربة تجارة إلكترونية لعلامة عطور منزلية عصرية",
    description:
    ...
    screenSections: [
      {
        title: "محتوى وسائل التواصل وبناء العلامة التجارية",
        body: [
    ...
    servicesSection: {
      ...
      intro: [
        "بالنسبة لـ FridaEU، لم نكتفِ بتطوير متجر إلكتروني، بل بنينا منظومة رقمية متكاملة تجمع بين العلامة التجارية والمحتوى والتجارة والتسويق بالأداء.",
        "من البنية التقنية للمتجر الإلكتروني مرورًا بمحتوى وسائل التواصل الاجتماعي وصولاً إلى الإعلانات المدفوعة والتجارة عبر منصات التواصل، نرافق العلامة التجارية عبر رحلة العميل الرقمية بالكامل.",
      ],
      items: [
        {
          icon: "shopping-bag",
  ...
  },
  {
    slug: "abziel",
    client: "ABZIEL",
    title: "وسائل التواصل الاجتماعي والريلز",
    description:
    ...
    services: ["تصميم المواقع", "التسويق عبر وسائل التواصل الاجتماعي", "التسويق بالأداء"],
    color: "sky",
    stripFit: "contain",
    ...
    screenSections: [
      {
        title: "محتوى وسائل التواصل والظهور",
        body: [
    ...
    servicesSection: {
      eyebrow: "خدماتنا",
      heading: "حضور رقمي يبني الثقة",
      intro:
        "بالنسبة لـ ABZiel، جمعنا بين تصميم المواقع ووسائل التواصل الاجتماعي والتسويق بالأداء في حضور رقمي متكامل – بهدف إبراز العروض التعليمية وبناء الثقة والوصول بفعالية إلى جمهور جديد.",
      ...
      closingStatement:
        "يتكامل الموقع الإلكتروني والمحتوى والتسويق بالأداء في ABZiel – لمزيد من الظهور والثقة ورابط رقمي أقوى بين العروض التعليمية والأشخاص الذين يحتاجونها.",
    },
  },
  {
    slug: "umzugly",
    client: "Umzugly",
    title: "تخطيط وإدارة الانتقال رقميًا",
    description:
    ...
    servicesSection: {
      eyebrow: "خدماتنا",
      heading: "منتج رقمي تدعمه صناعة المحتوى",
      intro:
  ...
  },
  {
    ...
    title: "المحتوى والتسويق بالأداء",
    description:
    ...
    year: 2025,
    categories: ["social-video"],
    services: ["إنتاج الفيديو", "التسويق بالأداء"],
    color: "sun",
    heroContain: true,
    ...
    servicesSection: {
      eyebrow: "خدماتنا",
      heading: "محتوى قوي وتسويق بالأداء لزيادة الظهور",
      intro:
  ...
  },
  {
    ...
    description:
      "يمثّل LOUIC خدمات سحب ونقل سريعة وموثوقة على مدار الساعة. بفضل التواجد 24/7 وسائقين ذوي خبرة وحلول مرنة، يضمن LOUIC وصول العملاء بسرعة وأمان في حالات الأعطال أو الحوادث أو نقل المركبات.",
    year: 2025,
    categories: ["social-video"],
    services: ["إعلانات Google", "التسويق بالأداء"],
    color: "sun",
    heroContain: true,
    ...
    servicesSection: {
      eyebrow: "خدماتنا",
      heading: "الظهور في اللحظة التي يحتاج فيها العميل إلى المساعدة",
      intro:
  ...
  },
  {
    ...
    description:
      "Netwitcher أكثر من مجرد وكالة رقمية – نحن نجمع بين الاستراتيجية والإبداع والتقنية في منظومة رقمية واحدة تُبرز العلامات التجارية وتحقق النمو. من الهوية البصرية والمحتوى، مرورًا بوسائل التواصل الاجتماعي والتسويق بالأداء، وصولاً إلى المواقع الإلكترونية، نطوّر كل نقطة تواصل بهدف واضح: تحويل الانتباه إلى نتائج قابلة للقياس.",
    year: 2025,
    categories: ["web", "design", "social-video"],
    services: ["تصميم المواقع", "الهوية البصرية والتصميم", "وسائل التواصل الاجتماعي", "المحتوى والفيديو", "التسويق بالأداء"],
    color: "violet",
    featured: true,
    useBrandLogo: true,
    cover: {
    ...
    servicesSection: {
      ...
      heading: "علامة واحدة، منظومة واحدة. كل شيء تحت سقف واحد.",
      intro:
        "Netwitcher هو ملعبنا الرقمي الخاص. هنا نجمع بين الاستراتيجية والتصميم والمحتوى والتقنية والتسويق بالأداء في علامة تجارية تصب فيها كل نقطة تواصل في التالية.",
    ...
    reelsSection: {
      ...
      heading: "محتوى يستحق التوقف عنده",
