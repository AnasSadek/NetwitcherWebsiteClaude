<?php /* Template Name: AGB */
/** app/agb/page.tsx (components/LegalPage.tsx wrapper via nw_legal_open/close). */
get_header();
$site = nw_site();
echo nw_legal_open('Allgemeine Geschäftsbedingungen (AGB)');
?>
      <h2>§ 1 Geltungsbereich</h2>
      <p>
        Diese Allgemeinen Geschäftsbedingungen gelten für alle Verträge zwischen der
        <?php echo esc_html($site['legalName']); ?>, <?php echo esc_html($site['street']); ?>, <?php echo esc_html($site['zip']); ?> <?php echo esc_html($site['city']); ?> (nachfolgend
      ...
      <p>
        ...
        <a href="<?php echo esc_url(nw_url('/datenschutz')); ?>">Datenschutzerklärung</a> und den geltenden
