<?php /* Template Name: Datenschutzerklärung */
/** app/datenschutz/page.tsx (components/LegalPage.tsx wrapper via nw_legal_open/close). */
get_header();
$site = nw_site();
echo nw_legal_open('Datenschutzerklärung');
?>
      ...
      <p>
        ...
        <?php echo esc_html($site['street']); ?>, <?php echo esc_html($site['zip']); ?> <?php echo esc_html($site['city']); ?><br>
