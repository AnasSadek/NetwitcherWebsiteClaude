...
export function Placeholder({
  ...
  return (
    <div
      aria-hidden="true"
      className={`relative h-full w-full overflow-hidden bg-paper-3 ${className}`}
      style={{
        backgroundColor: "#f2eeff",
        backgroundImage: `radial-gradient(120% 90% at 20% 0%, ${hex}26, transparent 60%), radial-gradient(rgba(21,10,51,0.12) 1px, transparent 1px)`,
        backgroundSize: "auto, 22px 22px",
      }}
    >
      <svg
        viewBox="0 0 100 100"
        className="absolute -right-[12%] -bottom-[14%] h-[70%] w-auto opacity-[0.10]"
        aria-hidden="true"
      >
