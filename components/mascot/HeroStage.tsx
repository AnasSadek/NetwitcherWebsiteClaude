 ...
 *   Maus     – im Hero-Bereich; verlässt sie ihn, kehrt der Blick weich
 *              in die neutrale Mitte zurück (Federn, kein Schnappen)
 ...
 * Reduced Motion: keine Kopplung, kein Schweben, nur ein sanfter Blitz.
 */
...
export function HeroStage() {
  ...
  // Innerhalb der Bühne (plus etwas Rand) folgt der Blick dem Cursor;
          ...
          >
            ...
            >
              ...
              {/* Kopfdrehung: Frame-Sequenz über dem statischen Poster
                  (Desktop mit Maus), vertikal als perspektivisches Nicken */}
              <HeadTurn
                manifest={HEAD_TURN}
              ...
              {/* Die Linse bleibt leer — dunkles Glas, nur ein wandernder
                  Glanzpunkt. Er folgt der Linse der Sequenz und läuft dem
                  Blick leicht entgegen. */}
              <motion.div
                data-witch="eye"
                aria-hidden="true"
