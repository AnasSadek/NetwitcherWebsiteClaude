...
export function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute right-full mr-3 hidden whitespace-nowrap rounded border border-line bg-night-800 px-4 py-2 text-xs font-medium text-snow opacity-0 transition-opacity duration-200 group-hover:opacity-100 sm:block">
