...
export function WhatsAppButton({ locale = "de" }: { locale?: Locale }) {
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute right-full mr-3 hidden whitespace-nowrap rounded border border-line bg-paper-2 px-4 py-2 text-xs font-medium text-ink opacity-0 transition-opacity duration-200 group-hover:opacity-100 sm:block">
        {t.whatsapp.tooltip}
      </span>
    </a>
  );
