...
export const metadata: Metadata = {
  ...
  description:
    "نتويتشر تصنع السحر لعلامتك التجارية: تصوير وفيديو من استوديونا الخاص في برلين، وسائل التواصل الاجتماعي والإعلانات، مواقع ومتاجر إلكترونية وبرمجيات. Magic in Every Click.",
