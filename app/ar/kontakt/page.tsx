...
export const metadata: Metadata = {
  ...
  description:
    "أخبرنا في ثلاث خطوات قصيرة عمّا تحتاجه: محتوى، جلسة تصوير، سوشيال ميديا، إعلانات، موقع إلكتروني، SEO، هوية بصرية أو برمجيات. نرد خلال يوم عمل واحد. من برلين.",
        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <header className="max-w-2xl">
            ...
            <p className="mt-5 max-w-md text-base leading-relaxed text-ink-3">
              ثلاث خطوات قصيرة، وبعدها نعرف ما يكفي لتقييم صادق. بلا استبيانات
              طويلة وبلا ضغط بيع.
            </p>
          </header>
