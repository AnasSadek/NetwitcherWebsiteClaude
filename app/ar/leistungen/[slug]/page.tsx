...
> = {
  ...
  "webdesign-ecommerce": {
    faqHeading: "أسئلة شائعة",
    ctaTitle: "جاهز لموقع يعمل لصالح أعمالك؟",
    ctaText:
      "أخبرنا عن مشروعك وأهدافك، وسنقترح عليك الحل الأنسب لبناء موقع سريع، واضح، وقادر على تحويل الزيارات إلى نتائج.",
  },
  seo: {
    faqHeading: "أسئلة شائعة",
    ctaTitle: "جاهز لتحويل البحث إلى مصدر نمو؟",
    ctaText:
      "أخبرنا عن موقعك وأهدافك، وسنوضح لك أين توجد فرص الظهور وكيف يمكن تحسين موقعك لجذب زيارات ذات قيمة على المدى الطويل.",
  },
  "branding-design": {
    faqHeading: "أسئلة شائعة",
    ctaTitle: "جاهز لبناء علامة يصعب نسيانها؟",
    ctaText:
  ...
  "technischer-support": {
    faqHeading: "أسئلة شائعة",
    ctaTitle: "هل تريد دعمًا تقنيًا يمكنك الاعتماد عليه؟",
    ctaText:
      "أخبرنا بما يحتاجه موقعك من صيانة أو دعم، وسنقترح خطة مناسبة للحفاظ عليه سريعًا، آمنًا، ومستقرًا.",
  },
  "druck-printdesign": {
    faqHeading: "أسئلة شائعة",
    ctaTitle: "جاهز لتحويل فكرتك إلى مطبوعات مميزة؟",
    ctaText:
      "أخبرنا بما تريد طباعته، وسنساعدك على تحويله إلى تصميم متناسق مع علامتك وجاهز للتنفيذ بجودة احترافية.",
  },
};
